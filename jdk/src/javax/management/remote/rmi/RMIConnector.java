...
public class RMIConnector implements JMXConnector, Serializable, JMXAddressable {
    ...
    /*
       ...
       as for RMI/JRMP.  We createVehicle a "ProxyDelegate" that is an
       ...
       So instead we do the following.  We createVehicle a subclass of the
       stub that overrides the _invoke method so as to wrap the
       returned InputStream in a ProxyInputStream.  We createVehicle a
